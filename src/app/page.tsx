        ...
        <div className="relative max-w-5xl mx-auto section-padding py-32 md:py-0">
          ...
          <Reveal delay={0.3}>
            <p className="text-lg md:text-xl text-earth-400 max-w-2xl leading-relaxed mb-10">
              Founded on the vision of restoring the dignity, intellectual
              sovereignty, and economic autonomy of African people — through
              indigenous governance, cultural heritage, and the living philosophy of
              Ubuntu.
            </p>
          </Reveal>
          <Reveal delay={0.45}>
        ...
        <div className="max-w-4xl mx-auto section-padding text-center">
          <Reveal>
            <p className="font-serif text-xl md:text-2xl text-earth-800 italic leading-relaxed">
              &ldquo;I am because we are — our custom and way of life.&rdquo;
            </p>
          </Reveal>
        </div>
      </section>
          ...
          {[
            {
              title: "Abantu",
              subtitle: "The People",
              text: "Our first loyalty is to the communities we serve — the rural poor, indigenous peoples, women and girls, youth, and those living at the margins. Every decision begins and ends with the question: does this serve the people?",
              icon: "👤",
            },
            {
              title: "Ubuntu",
              subtitle: "I Am Because We Are",
              text: "Ubuntu is not sentiment — it is a governance system. No individual, organisation, or institution thrives in isolation. Relationships built on dignity, reciprocity, and mutual accountability are the infrastructure of all our work.",
              icon: "🤝",
            },
            {
              title: "Isintu",
              subtitle: "Our Custom and Way of Life",
        ...
        <div className="max-w-6xl mx-auto section-padding">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {[
              ...
              { icon: Heart, label: "National GBV Centre Rollout", href: "/our-work" },
            ].map((item, i) => (
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <p className="text-earth-600 leading-relaxed mb-6">
                Isintu Samakhosi Institution is a Non-Profit Company incorporated under
                Section 21 of the Companies Act, building the economic, institutional,
                and cultural infrastructure that allows rural communities to generate
                their own wealth and govern their own affairs — in partnership with
                chiefdoms and kingdoms across South Africa&apos;s nine provinces.
              </p>
            </Reveal>
            <Reveal delay={0.2}>
