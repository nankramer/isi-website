  ...
  return (
    <>
      ...
      <Section>
        ...
        <SectionTitle>Environmental Stewardship</SectionTitle>

        <Reveal>
          <p className="text-earth-600 leading-relaxed mb-6 max-w-3xl">
            We recognise that the land, water, and natural environment are not merely
            resources — they are the physical expression of Isintu, the ancestral
            covenant between Abantu and their territory. We apply Ubuntu ecological
            principles: taking only what is needed, restoring what is used, and
