...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Isintu Samakhosi Institution is a Non-Profit Company dedicated to restoring the dignity, intellectual sovereignty, and economic autonomy of African people.",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Isintu Samakhosi Institution exists to serve as a vehicle for systemic change, institutional memory, and intergenerational wisdom — rooted in the living philosophy of the Nguni peoples of Southern Africa."
      />
      ...
      <Section>
        <Reveal>
          <p className="text-lg text-earth-600 leading-relaxed mb-6">
            Isintu Samakhosi Institution is a Non-Profit Company (NPC) incorporated
        ...
        <Reveal delay={0.1}>
          <p className="text-lg text-earth-600 leading-relaxed mb-6">
            Our name tells our story. The Institution draws its foundational identity
        ...
        <Reveal delay={0.15}>
          <p className="text-lg text-earth-600 leading-relaxed">
            All decisions, strategies, and actions of the Institution are guided by the
        ...
        <Reveal>
          <p className="text-earth-600 leading-relaxed mb-8 max-w-3xl">
            The Institution is guided by three founding pillars that constitute its
        ...
        {[
          ...
          },
          {
            ...
            text: "The exercise of fiduciary, environmental, and intergenerational responsibility over all resources entrusted to the Institution. All resources — financial, human, natural, cultural, and digital — are managed with long-term sustainability, transparency, and intergenerational accountability.",
          },
        ].map((pillar, i) => (
          <Reveal key={pillar.title} delay={i * 0.1}>
            <div className="mb-10 last:mb-0">
        ...
        <Reveal>
          <p className="text-earth-600 leading-relaxed mb-6 max-w-3xl">
            The Institution is governed by a Board of Directors comprising individuals
        ...
        <Reveal delay={0.1}>
          <p className="text-earth-600 leading-relaxed mb-6 max-w-3xl">
            The Institution is non-partisan. While we engage in advocacy on issues
          ...
          <div className="bg-stone/50 border border-gold/10 p-8 md:p-10">
            <div className="space-y-5">
              ...
              <p className="text-earth-600 leading-relaxed">
                ...
                Institution, where he promotes the integration of traditional
          ...
          <div className="bg-stone/50 border border-gold/10 p-8 md:p-10">
            <div className="space-y-5">
              <p className="text-earth-600 leading-relaxed">
                ...
                as Deputy President and International Ambassador of the Institution.
              </p>
              <p className="text-earth-600 leading-relaxed">
              ...
              <p className="text-earth-600 leading-relaxed">
                ...
                realities the Institution serves.
              </p>
              <p className="text-earth-600 leading-relaxed">
              ...
              <p className="text-earth-600 leading-relaxed">
                Lindiwe leads the Institution&apos;s Indigenous Leadership alignment,
                engaging directly with Amakhosi, Traditional Councils, and Royal
                Houses. As International Ambassador, she represents the Institution
        ...
        {/* Board Member - Prof Ngobese */}
        <SectionTitle>Prof. Nomagugu Patience Ngobese — Board Member & National Spokesperson</SectionTitle>
        <Reveal>
          <div className="bg-stone/50 border border-gold/10 p-8 md:p-10">
            <div className="space-y-5">
              <p className="text-earth-600 leading-relaxed">
                Professor Nomagugu Patience Ngobese is a respected cultural leader,
                educator, and lifelong activist whose work spans over three decades
                of advancing cultural inclusion, indigenous knowledge systems, and
                Ubuntu-based societal values. She serves as Board Member for Ubuntu
                Heritage Governance, National Spokesperson for Ubuntuology, and
                Royal Council Endorsed Leader.
              </p>
              <p className="text-earth-600 leading-relaxed">
                Professor Ngobese is widely recognised for her pivotal role in the
                revival of the Nomkhubulwane cultural practices and festivals — a
                significant contribution that reawakened important spiritual and
                cultural traditions within communities across KwaZulu-Natal and
                beyond. Through this work and her broader advocacy, she has promoted
                cultural inclusion in modern society, preserved and transferred
                indigenous knowledge systems across generations, and guided youth
                development through culturally grounded frameworks.
              </p>
              <p className="text-earth-600 leading-relaxed">
                Within the Institution, Professor Ngobese anchors all work in credible,
                community-endorsed cultural authority — ensuring alignment between
                tradition, community, and institutional governance systems. She
                advances a clear and disciplined national narrative on Ubuntu as a
                living standard, supports community-based cultural practitioners and
                traditional artisans in developing sustainable enterprises, and
                champions women-led cultural enterprises.
              </p>
              <p className="text-earth-600 leading-relaxed">
                As a Royal Council Endorsed Leader, her endorsement by the Amakhosi
                and Traditional Councils provides the institutional credibility
                required to operate effectively within indigenous governance
                frameworks — ensuring that programmes are culturally appropriate,
                community-endorsed, and that the interface between modern
                institutional systems and indigenous leadership remains coherent.
              </p>
              <p className="text-earth-600 leading-relaxed">
                Her voice has featured across Ukhozi FM, SABC 1, e.tv, and the BBC,
                shaping national and international conversations around identity,
                values, and the role of culture in a rapidly changing society.
              </p>
            </div>
            <div className="mt-6 pt-6 border-t border-gold/10">
              <p className="text-earth-500 text-sm italic">
                &ldquo;Akukhona ukuhlakanipha kwami — abangithumile.&rdquo;
                <span className="block mt-1 text-earth-400">It is not my wisdom, but those who sent me.</span>
              </p>
            </div>
          </div>
        </Reveal>
        ...
        <Reveal>
          <div className="grid sm:grid-cols-2 gap-x-8 gap-y-3 mt-4">
            {[
              ...
              { label: "Trading Name", value: "Isintu Samakhosi Institution" },
