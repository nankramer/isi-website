...
export const metadata: Metadata = {
  title: "News & Research",
  description:
    "Thought leadership, research, and updates from Isintu Samakhosi Institution.",
};
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Thought leadership, research, policy briefs, and updates from Isintu Samakhosi Institution."
      />
