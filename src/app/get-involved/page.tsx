...
const audiences = [
  ...
  },
  {
    ...
    text: "We welcome individuals with skills in community development, agriculture, finance, legal, technology, and research. All volunteers complete our mandatory induction, safeguarding training, and sign our Code of Conduct and PSEA policy as a condition of engagement.",
            ...
            <Reveal delay={0.1}>
              <form onSubmit={handleSubmit} className="space-y-5 mt-8">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    <label className="block text-xs text-earth-400 mb-1.5 font-medium">
                      Traditional Authority / Chiefdom
                    </label>
                    <input
                      type="text"
                      placeholder="e.g. Inkosi Zondi, AmaHlubi"
                      value={formData.traditionalAuthority}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          traditionalAuthority: e.target.value,
                        })
                      }
                      className="w-full bg-earth-800 border border-earth-700 text-white px-4 py-3 text-sm focus:border-gold focus:outline-none transition-colors placeholder:text-earth-600"
                    />
                  </div>
                </div>
