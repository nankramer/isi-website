...
const programmes = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Each centre is supported by a community-based User Group (UG) — the eyes, ears, and accountability mechanism of the Institution on the ground. No centre opens until all eight pre-deployment control documents are filed, including a community baseline assessment, Traditional Council Resolution, referral pathway map, and risk and safety plan.",
